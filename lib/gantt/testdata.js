var demo_tasks ={
		"data":[
			{"id":11, "text":"SO#45637", type:gantt.config.types.project, "progress": 0.6, "open": true},

			{"id":12, "text":"Warp", "start_date":"20-12-2016", "duration":"3", "parent":"17", "progress": 1, "open": true},

			{"id":13, "text":"Weft", "start_date":"20-12-2016", "duration":"3", "parent":"17", "progress": 1, "open": true},

			{"id":17, "text":"Stores", "start_date":"20-12-2016", "duration":"3", "parent":"11", "progress": 1, "open": true,type:gantt.config.types.project},

			{"id":18, "text":"Dyeing", "start_date":"23-12-2016", "duration":"2", "parent":"11", "progress": 0.8, "open": true,type:gantt.config.types.project},

			{"id":14, "text":"DyeingWarp", "start_date":"23-12-2016", "duration":"2", "parent":"18", "progress": 0.8, "open": true},
			{"id":15, "text":"DyeingWeft", "start_date":"23-12-2016", "duration":"2", "parent":"18", "progress": 0.8, "open": true},


			{"id":19, "text":"Weaving", "start_date":"27-12-2016", "duration":"4", "parent":"11", "progress": 0.2, "open": true},
			{"id":20, "text":"Printing", "start_date":"31-12-2016", "duration":"4", "parent":"11", "progress": 0.1, "open": true},
			{"id":21, "text":"Stiching", "start_date":"05-01-2017", "duration":"4", "parent":"11", "progress": 0.2, "open": true},
			{"id":22, "text":"Invoice", "start_date":"10-01-2017", "duration":"4", "parent":"11", "progress": 0.3, "open": true},
			
		],
		"links":[
			{"id":"10","source":"11","target":"17","type":"0"},
			{"id":"11","source":"12","target":"14","type":"0"},
			{"id":"12","source":"13","target":"15","type":"0"},
			{"id":"13","source":"16","target":"13","type":"0"},
			...
			{"id":"20","source":"21","target":"22","type":"0"},
	...
	var demo_tasks2={
		"data":[
			{"id":11, "text":"SO#45637", type:gantt.config.types.project, "progress": 0.6, "open": true},
			/*
			{"id":12, "text":"Stores", "start_date":"02-04-2013", "duration":"5", "parent":"11", "progress": 1, "open": true},
			{"id":13, "text":"Dyeing", "start_date":"03-04-2013", type:gantt.config.types.project, "parent":"11", "progress": 0.5, "open": true},
			{"id":14, "text":"Weaving", "start_date":"02-04-2013", "duration":"6", "parent":"11", "progress": 0.8, "open": true},
			{"id":15, "text":"Printing", type:gantt.config.types.project, "parent":"11", "progress": 0.2, "open": true},
			{"id":16, "text":"Stiching", type:gantt.config.types.project, "parent":"11", "progress": 0.2, "open": true},
			{"id":17, "text":"Invoice", type:gantt.config.types.project, "parent":"11", "progress": 0.2, "open": true},*/

			/*{"id":17, "text":"Invoice", "start_date":"15-04-2013", type:gantt.config.types.milestone, "parent":"11", "progress": 0.5, "open": true},*/

			{"id":17, "text":"Stores", "start_date":"20-12-2016", "duration":"3", "parent":"11", "progress": 1, "open": true},
			{"id":18, "text":"Dyeing", "start_date":"23-12-2016", "duration":"2", "parent":"11", "progress": 0.8, "open": true},
			{"id":19, "text":"Weaving", "start_date":"27-12-2016", "duration":"4", "parent":"11", "progress": 0.2, "open": true},
			{"id":20, "text":"Printing", "start_date":"31-12-2016", "duration":"4", "parent":"11", "progress": 0.1, "open": true},
			{"id":21, "text":"Stiching", "start_date":"05-01-2017", "duration":"4", "parent":"11", "progress": 0.2, "open": true},
			{"id":22, "text":"Invoice", "start_date":"10-01-2017", "duration":"4", "parent":"11", "progress": 0.3, "open": true},
			/*{"id":21, "text":"Task #4.1", "start_date":"02-04-2013", "duration":"4", "parent":"11", "progress": 0.5, "open": true},
			{"id":22, "text":"Task #4.2", "start_date":"02-04-2013", "duration":"4", "parent":"11", "progress": 0.1, "open": true},
		...
		"links":[
			...
			{"id":"19","source":"20","target":"21","type":"0"},
			{"id":"20","source":"21","target":"22","type":"0"},
			{"id":"21","source":"22","target":"23","type":"0"},
