angular.module('app')
  .controller('machineController', ['$location','$filter','$scope', '$state','$stateParams','$mdDialog','dialogFactory','JWTTOKEN', function($location,$filter,$scope,
    ...
    { 
    	...
    	JWTTOKEN.requestFunction('POST','machinecalendars/setBlackOutDayForMultipleMachines',obj).then(function(res){
    	   blackout.machines.forEach(function(boMachine) {
	    	   ...
	    	   JWTTOKEN.requestFunction('POST','holidays',holidayObj).then(function(holidayResponse){
