                           ...
                           //  var processTicketID="";
                            ...
                            // console.log(new Date(machineEventsDraft[key][key_machinecalendar].date));
                             ...
                             console.log(machineEventsDraft[key]);
                              var accessstatus=checkEventAccessebility(machineEventsDraft[key].workcentervendor);
...
{
  console.log(workcentervendor);
  if(sessionStorage.getItem('role')=="scheduler")
  {
    if(sessionStorage.getItem('userId')==workcentervendor.schedulerID)
    {
      return false;
                          ...
                          $scope.dialogData = dialogData;
                           ...
                           $scope.workcentervendorOnChange = function(selectedworkcentervendor) { 
                            console.log(selectedworkcentervendor);
                               ...
                               JWTTOKEN.requestFunction('GET','machines?filter[where][workcenterVendorID]='+selectedworkcentervendor).then(function(machines){
...
var taskrow=gantt.attachEvent("onTaskRowClick111", function(id,e){
 /* if(displithappen)
    return false
*/
  console.log(e);
